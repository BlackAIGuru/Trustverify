  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Integration Examples</h1>
          <p className="text-gray-600 mt-1">Real-world examples and implementation patterns for TrustVerify SDK</p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {integrationScenarios.map((scenario) => {
              ...
              return (
                <Card key={scenario.id} className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                  <CardHeader className="text-center">
                    <div className={`w-12 h-12 mx-auto mb-3 rounded-lg bg-${scenario.color}-100 flex items-center justify-center`}>
        ...
        <section className="space-y-8">
          <h2 className="text-2xl font-bold text-gray-900">Implementation Examples</h2>
              ...
              <CardContent>
                <div className="bg-gray-900 rounded-lg p-4 relative">
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="bg-blue-100 text-blue-800">E-commerce Checkout</Badge>
                    <Button
                      size="sm"
                      variant="ghost"
                    ...
                    >
                      {copiedCode === 'ecommerce' ? <CheckCircle className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                    </Button>
                  </div>
                  <pre className="text-gray-100 font-mono text-sm overflow-x-auto max-h-96">{examples.ecommerce}</pre>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div id="example-marketplace">
            <Card className="bg-white border border-gray-200 shadow-sm">
              ...
              <CardContent>
                <div className="bg-gray-900 rounded-lg p-4 relative">
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="bg-green-100 text-green-800">Freelance Platform</Badge>
                    <Button
                      size="sm"
                      variant="ghost"
                      ...
                      className="text-gray-400 hover:text-white"
                    >
                      {copiedCode === 'marketplace' ? <CheckCircle className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                    </Button>
                  </div>
                  <pre className="text-gray-100 font-mono text-sm overflow-x-auto max-h-96">{examples.marketplace}</pre>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div id="example-fintech">
            <Card className="bg-white border border-gray-200 shadow-sm">
              ...
              <CardContent>
                <div className="bg-gray-900 rounded-lg p-4 relative">
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="bg-purple-100 text-purple-800">Fintech Platform</Badge>
                    <Button
                      size="sm"
                      variant="ghost"
                      ...
                      className="text-gray-400 hover:text-white"
                    >
                      {copiedCode === 'fintech' ? <CheckCircle className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                    </Button>
                  </div>
                  <pre className="text-gray-100 font-mono text-sm overflow-x-auto max-h-96">{examples.fintech}</pre>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div id="example-enterprise">
            <Card className="bg-white border border-gray-200 shadow-sm">
              ...
              <CardContent>
                <div className="bg-gray-900 rounded-lg p-4 relative">
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="bg-orange-100 text-orange-800">Enterprise Platform</Badge>
                    <Button
                      size="sm"
                      variant="ghost"
                      ...
                      className="text-gray-400 hover:text-white"
                    >
                      {copiedCode === 'enterprise' ? <CheckCircle className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                    </Button>
                  </div>
                  <pre className="text-gray-100 font-mono text-sm overflow-x-auto max-h-96">{examples.enterprise}</pre>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div id="example-webhook">
            <Card className="bg-white border border-gray-200 shadow-sm">
              ...
              <CardContent>
                <div className="bg-gray-900 rounded-lg p-4 relative">
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="bg-purple-100 text-purple-800">Webhook Handler</Badge>
                    <Button
                      size="sm"
                      variant="ghost"
                  ...
                  <pre className="text-gray-100 font-mono text-sm overflow-x-auto max-h-96">{examples.webhook}</pre>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="mt-12">
          <Card className="bg-white border border-gray-200 shadow-sm">
            <CardHeader>
              <CardTitle className="text-xl text-gray-900 flex items-center">
                <Github className="h-6 w-6 mr-2 text-gray-900" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <h4 className="font-medium text-gray-900">Next.js E-commerce</h4>
                  </div>
                  <p className="text-sm text-gray-600 mb-3">Complete e-commerce store with TrustVerify integration</p>
                  <div className="flex space-x-2">
                    <Button size="sm" variant="outline" onClick={() => window.open('https://github.com/trustverify/nextjs-ecommerce-demo', '_blank')}>
                      <ExternalLink className="h-4 w-4 mr-1" />
                      View Code
                    </Button>
                    <Button size="sm" onClick={() => window.open('https://demo-ecommerce.trustverify.com', '_blank')}>
                      Live Demo
                    </Button>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3 mb-3">
                    <Github className="h-5 w-5 text-gray-600" />
                    <h4 className="font-medium text-gray-900">React Marketplace</h4>
                  </div>
                  <p className="text-sm text-gray-600 mb-3">Freelance marketplace with milestone payments</p>
                  <div className="flex space-x-2">
                    <Button size="sm" variant="outline" onClick={() => window.open('https://github.com/trustverify/react-marketplace-demo', '_blank')}>
                      <ExternalLink className="h-4 w-4 mr-1" />
                      View Code
                    </Button>
                    <Button size="sm" onClick={() => window.open('https://demo-marketplace.trustverify.com', '_blank')}>
                      Live Demo
                    </Button>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3 mb-3">
                    <Github className="h-5 w-5 text-gray-600" />
                    <h4 className="font-medium text-gray-900">Python Flask API</h4>
                  </div>
                  <p className="text-sm text-gray-600 mb-3">Backend API integration with webhook handling</p>
                  <div className="flex space-x-2">
                    <Button size="sm" variant="outline" onClick={() => window.open('https://github.com/trustverify/python-flask-demo', '_blank')}>
                      <ExternalLink className="h-4 w-4 mr-1" />
                      View Code
                    </Button>
                    <Button size="sm" onClick={() => window.open('/postman-collection', '_blank')}>
        ...
        {/* Support CTA */}
        <Card className="bg-blue-50 border border-blue-200 shadow-sm mt-8">
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              <Code className="h-8 w-8 text-blue-600" />
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-blue-900">Need Custom Integration Help?</h3>
                <p className="text-blue-700">Our integration team can help you implement TrustVerify for your specific use case.</p>
              </div>
              <div className="space-x-2">
                ...
                <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={() => window.open('mailto:integrations@trustverify.com?subject=Custom Integration Request', '_blank')}>
                  Contact Team
                </Button>
              </div>
            </div>
