...
import { Book, ExternalLink, Code, Play } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Complete reference for the TrustVerify API with examples and interactive testing.
          </p>
        </div>
                      ...
                      {section.endpoints.map((endpoint, endpointIndex) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2 text-sm hover:bg-blue-50 border-b ${
                            activeEndpoint === `${section.title}-${endpointIndex}` ? 'bg-blue-100' : ''
                          }`}
          ...
          <div className="lg:col-span-3">
            <Tabs defaultValue="overview" className="space-y-6">
              ...
              <TabsContent value="overview">
                <Card>
                  <CardHeader>
                    <CardTitle>TrustVerify API Overview</CardTitle>
                  </CardHeader>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border rounded p-3">
                          ...
                          <p className="text-sm text-gray-600 mt-1">Insufficient permissions</p>
                        </div>
                        <div className="border rounded p-3">
              ...
              <TabsContent value="testing">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <h4 className="font-medium mb-3">Testing Environments</h4>
