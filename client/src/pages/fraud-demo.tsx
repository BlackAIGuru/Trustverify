    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">TrustVerify Business Demo</h1>
              <p className="text-lg text-gray-600 mt-2">Experience real-time business fraud prevention in action</p>
            </div>
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-gray-900 text-sm">Demo Steps:</h4>
                ...
                {/* Demo Statistics */}
                <div className="space-y-3 pt-4 border-t border-gray-200">
                  <h4 className="font-semibold text-gray-900 text-sm">Live Statistics:</h4>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-blue-600">99.8%</div>
                      <div className="text-xs text-blue-800">Detection Rate</div>
                    </div>
                    <div className="bg-green-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-green-600">&lt; 3s</div>
                      <div className="text-xs text-green-800">Process Time</div>
                    </div>
                    <div className="bg-purple-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-purple-600">£1.9B</div>
                      <div className="text-xs text-purple-800">Protected</div>
                    </div>
                    <div className="bg-yellow-50 p-3 rounded-lg">
                      <div className="text-lg font-bold text-yellow-600">72h</div>
                      <div className="text-xs text-yellow-800">Resolution</div>
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-green-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Complete Business Fraud Prevention Solution</h2>
              ...
              return (
                <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                  <CardHeader className="text-center pb-4">
                    <div className={`h-16 w-16 bg-${feature.color}-100 rounded-full flex items-center justify-center mx-auto mb-4`}>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center justify-center space-x-4 bg-white rounded-xl p-6 shadow-lg">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">From Detection</div>
                <div className="text-sm text-gray-600">AI-powered analysis</div>
              </div>
              <ArrowRight className="h-8 w-8 text-gray-400" />
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">To Resolution</div>
                <div className="text-sm text-gray-600">Complete settlement</div>
              </div>
            </div>
          </div>
        </div>
