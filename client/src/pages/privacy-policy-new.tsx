                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <p className="text-green-700 text-sm">
                      Contact our Data Protection Officer at <strong>dpo@trustverify.io</strong> or use our 
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-2">
                      <p className="text-gray-700">
                        <strong>Data Protection Officer:</strong> dpo@trustverify.io
                      </p>
                      <p className="text-gray-700">
                        <strong>Privacy Team:</strong> privacy@trustverify.io
                      </p>
                      <p className="text-gray-700">
                        <strong>General Inquiries:</strong> support@trustverify.io
                      </p>
                    </div>
                  </div>
