            ...
            <TabsContent value="api-keys" className="space-y-6">
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">API Keys</h2>
                    <p className="text-gray-600">Manage your API keys for secure access to TrustVerify services</p>
                  </div>
                  <Button 
                    className="bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => setActiveTab("create-key")}
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-2 mt-3">
                            <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">
                              {showApiKey[key.id] ? key.key : `${key.keyPrefix}${'*'.repeat(32)}`}
                            </code>
                            <Button
                              size="sm"
                              variant="ghost"
                ...
                {apiKeys.length === 0 && (
                  <Card className="bg-white border border-gray-200 shadow-sm">
                    <CardContent className="p-12 text-center">
                      ...
                      <p className="text-gray-600 mb-6">Create your first API key to start integrating with TrustVerify</p>
                      <Button 
                        className="bg-blue-600 hover:bg-blue-700 text-white"
                        onClick={() => setActiveTab("create-key")}
                      >
