            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p className="text-gray-700">
                    <strong>Chief Compliance Officer:</strong> compliance@trustverify.io
                  </p>
                  <p className="text-gray-700">
                    <strong>AML Officer:</strong> aml@trustverify.io
                  </p>
                  <p className="text-gray-700">
                    <strong>Data Protection Officer:</strong> dpo@trustverify.io
                  </p>
                  <p className="text-gray-700">
                    <strong>Regulatory Affairs:</strong> regulatory@trustverify.io
                  </p>
                </div>
              </CardContent>
            </Card>
