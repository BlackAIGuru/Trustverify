...
const transactionSchema = z.object({
  ...
  terms: z.string().min(10, "Terms must be at least 10 characters").max(500, "Terms must be less than 500 characters"),
});
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex flex-col">
                    <span className="font-semibold" style={{ color: 'var(--text-primary)' }}>Transaction Details</span>
                    <span className="text-sm" style={{ color: 'var(--text-muted)' }}>Basic information</span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex flex-col">
                    <span className="font-semibold" style={{ color: 'var(--text-primary)' }}>Terms & Review</span>
                    <span className="text-sm" style={{ color: 'var(--text-muted)' }}>Final confirmation</span>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <CardContent className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              <DollarSign className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5" style={{ color: 'var(--text-muted)' }} />
                              <Input
                                id="amount"
                                type="number"
                                step="0.01"
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => form.setValue("deliveryTimeframe", value)}>
                              <SelectTrigger 
                                className="h-12 text-base border-2 rounded-xl"
                                style={{
                  ...
                  {step === 2 && (
                    <Card className="tv-card">
                      <CardHeader>
                        ...
                        <CardDescription className="tv-body" style={{ color: 'var(--text-secondary)' }}>
                          Define the terms and conditions for this transaction
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div className="space-y-2">
                          <Label htmlFor="terms" className="text-base font-semibold" style={{ color: 'var(--text-primary)' }}>
                            Terms & Conditions *
                          </Label>
                          <Textarea
                            id="terms"
                            ...
                            className="min-h-32 text-base border-2 rounded-xl resize-none"
                            style={{
                              borderColor: form.formState.errors.terms ? 'var(--error)' : 'var(--border)',
                              backgroundColor: 'var(--surface)'
                            }}
                            placeholder="Define payment terms, refund policy, dispute resolution process, etc."
                          />
                        ...
                        <div className="flex justify-between">
                          ...
                          <Button
                            type="submit"
                            disabled={createTransactionMutation.isPending || !form.formState.isValid}
                            className="tv-btn-large"
                            style={{
