...
export default function HomePage() {
  ...
  const stats = [
    { label: "Detection + Resolution", value: "End-to-End", icon: Shield },
    { label: "Dispute Settlement", value: "72 Hours", icon: Clock },
    { label: "Trust Pages", value: "Public Verification", icon: Award },
    { label: "Global Intelligence", value: "Global Intelligence", icon: Globe },
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Comprehensive global threat intelligence to protect your business worldwide.",
      icon: Globe,
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="bg-white border-b border-gray-100 sticky top-0 z-[100] backdrop-blur-sm bg-white/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button 
                onClick={() => handleNavigateToPage('/platform')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors"
              >
                Platform
              </button>
              <button 
                onClick={() => handleNavigateToPage('/developers')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors"
              >
                Developers
              </button>
              <button 
                onClick={() => handleNavigateToPage('/business')}
                className="text-gray-600 hover:text-blue-600 font-medium transition-colors"
              >
                Business
              </button>
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <>
                  <Button 
                    onClick={() => handleNavigateToPage('/auth')}
                    variant="ghost"
                    className="text-gray-600 hover:text-blue-600 font-medium transition-colors px-4 py-2 hidden md:inline-flex"
                  >
                    Sign In
                  </Button>
                  <Button 
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button 
                  onClick={() => {
                    handleNavigateToPage('/developers');
                    setMobileMenuOpen(false);
                  }} 
                  className="block w-full text-left px-3 py-2 text-gray-600 hover:text-blue-600 font-medium"
                >
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                  <span className="block text-white drop-shadow-lg font-extrabold">Global Transaction Security</span>
                  <span className="block text-blue-200 drop-shadow-lg font-extrabold">& Fraud Intelligence</span>
                </h1>
                ...
                {/* Brand Values in Hero */}
                <BrandValues language={language} variant="hero" />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-8 pt-8">
                ...
                <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
                  ...
                  <span className="text-sm font-medium text-gray-100">Enterprise-Grade</span>
                </div>
              </div>
            </div>
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500">Protection Suite</div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-3 rounded-xl bg-yellow-50 border border-yellow-200">
                      ...
                      <div className="text-xs text-yellow-600">Secure</div>
                    </div>
                  ...
                  <div className="p-4 rounded-xl bg-purple-50 border border-purple-200">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-gray-900">Dispute Resolution</span>
                      </div>
                      <div className="text-sm font-bold text-purple-600">72hr Process</div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-600">Fast buyer protection</span>
                        <div className="flex items-center">
                          <div className="w-2 h-2 bg-purple-400 rounded-full mr-2"></div>
                          <span className="text-xs font-semibold text-purple-600">Guaranteed</span>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-600">Expert mediation</span>
                        <CheckCircle className="h-4 w-4 text-green-600" />
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-600">Buyer satisfaction ensured</span>
                        <CheckCircle className="h-4 w-4 text-green-600" />
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Beyond Detection: Complete Resolution
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              While others stop at fraud detection, TrustVerify handles end-to-end resolution with built-in dispute settlement
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Global Detection</h3>
              <p className="text-gray-600">Worldwide fraud intelligence covering all payment methods, digital transactions, and emerging threat patterns</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Funds held securely with payment partners until fraud verification completes</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Internal Settlement</h3>
              <p className="text-gray-600">72-hour internal settlement process for swift transaction resolution and dispute handling</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Public Trust Pages for Every Business</h2>
            <p className="text-lg text-gray-600">Build reputation with verified trust badges and public transparency</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Verified Business</h3>
                  <p className="text-sm text-gray-500">Trust Score: 98/100</p>
                </div>
              </div>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span className="text-sm text-gray-700">No Fraud Reports</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span className="text-sm text-gray-700">Payment Protected</span>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-teal-50 border-2 border-blue-200 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Global Intelligence</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Payment Fraud</span>
                  <span className="px-2 py-1 bg-red-100 text-red-700 text-xs rounded-full">High Risk</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Digital Transaction Scams</span>
                  <span className="px-2 py-1 bg-yellow-100 text-yellow-700 text-xs rounded-full">Medium Risk</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Social Engineering</span>
                  <span className="px-2 py-1 bg-red-100 text-red-700 text-xs rounded-full">High Risk</span>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-blue-200">
                <p className="text-xs text-gray-600">Live threat intelligence for global markets</p>
              </div>
            </div>

            {/* 2-Click Integration */}
            <div className="bg-gradient-to-br from-teal-50 to-green-50 border-2 border-teal-200 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">2-Click Integration</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  <div className="w-6 h-6 bg-blue-600 rounded text-white text-xs flex items-center justify-center">W</div>
                  <span className="text-sm text-gray-700">WordPress Plugin</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-6 h-6 bg-green-600 rounded text-white text-xs flex items-center justify-center">S</div>
                  <span className="text-sm text-gray-700">Shopify Integration</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Code className="h-4 w-4 text-gray-600" />
                  <span className="text-sm text-gray-700">Simple API Setup</span>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-teal-200">
                <p className="text-xs text-gray-600">Ready for SMEs with minimal technical setup</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-8 text-center relative overflow-hidden hover:shadow-xl transition-all duration-300 border border-green-200/50">
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-center space-x-4 text-sm">
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full">AI-Powered</span>
                  <span className="bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full">Real-Time</span>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-8 text-center relative overflow-hidden hover:shadow-xl transition-all duration-300 border border-blue-200/50">
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-center space-x-4 text-sm">
                  <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Enterprise-Grade</span>
                  <span className="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full">SOC 2 Ready</span>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 text-sm">
                    <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full">Enterprise-Ready</span>
            ...
            <div className="group bg-gradient-to-br from-cyan-50 to-teal-100 rounded-xl p-8 relative overflow-hidden hover:shadow-xl transition-all duration-300 border border-cyan-200/50">
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 text-sm">
                    <span className="bg-cyan-100 text-cyan-800 px-3 py-1 rounded-full">Coming Soon</span>
          ...
          <div className="text-center mb-12">
            <div className="bg-white rounded-xl p-8 shadow-md max-w-2xl mx-auto">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                Building Trust with Our First Partners
              </h3>
              <p className="text-gray-600 mb-6">
                TrustVerify launched in 2025. We're actively onboarding our first enterprise clients and will showcase their partnerships here as they join our platform.
              </p>
          ...
          {testimonials.length > 0 ? (
            ...
            <div className="text-center py-12">
              <div className="bg-white rounded-xl p-8 shadow-md max-w-md mx-auto">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">No Client Reviews Yet</h3>
                <p className="text-gray-600 mb-6">
                  TrustVerify launched in 2025. We're building trust with our first clients and will showcase their feedback here soon.
                </p>
                <Button 
                  onClick={() => window.location.href = '/auth'}
                  className="bg-blue-600 hover:bg-blue-700 text-white"
      ...
      <FeatureDiscovery language={language} />
